...
public class DifficultTests {
    ...
    public void firstTest(){
        ...
        WebDriverWait customWaitBusiness = new WebDriverWait(driver, Duration.ofSeconds(10));

        customWaitBusiness.until(ExpectedConditions.textToBePresentInElementLocated(businessPriceBy, "266"));
